import { NEW_POST, IS_COMMENT, UPDATE_CMT, DELETE_NOTIFICATION, SHOW_COMMENT, NOTIFICATION, CLEAN_NOTIFICATION, CHILD_CLICKED, START_LOADING, END_LOADING, COMMENT, FETCH_ALL, CREATE, DELETE, UPDATE } from '../constants/actionTypes'

const posts = (state = { childClicked: -1, updateNumberCmt: '', isComments: [], notifications: [], newPost: {}, isLoading: false, posts: [], showComment: null }, action) => {
    switch (action.type) {
        case START_LOADING:
